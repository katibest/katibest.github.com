defmodule KatiPortfolioWeb.ProjectControllerTest do
  use KatiPortfolioWeb.ConnCase

  import KatiPortfolio.PortfolioFixtures

  @create_attrs %{description: "some description", image_path: "some image_path", title: "some title", year: "some year"}
