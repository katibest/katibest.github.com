...
config :kati_portfolio,
  ecto_repos: [KatiPortfolio.Repo],
...
config :kati_portfolio, KatiPortfolioWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: KatiPortfolioWeb.ErrorHTML, json: KatiPortfolioWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: KatiPortfolio.PubSub,
  live_view: [signing_salt: "rlO2Wcep"]
